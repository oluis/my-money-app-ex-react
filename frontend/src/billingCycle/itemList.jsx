...
import {Field, arrayInsert, arrayRemove} from 'redux-form' //ver documentacao redux-form tem os Field, arrayInsert
      ...
      return list.map((item, index) =>(
        <tr key={index}>
          <td><Field name={`${this.props.field}[${index}].name`} component={Input}
                    placeholder='Informe nome' readOnly={this.props.readOnly}/></td>
